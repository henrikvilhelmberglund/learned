...
export const themes = createThemes([
	...
	{ name: "emerald", primary: colors.emerald, secondary: colors.orange, gray: colors.gray },
	{ name: "orange", primary: colors.orange, secondary: colors.pink, gray: colors.stone },
	{ name: "rose", primary: colors.rose, secondary: colors.pink, gray: colors.stone },
]);
